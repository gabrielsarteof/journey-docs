# Diagrama Simplificado 4: Execução e Avaliação
...
flowchart LR
    ...
    B -->|GPT-4| C
    C --> D[Código]
    D --> E[Judge0<br/>Sandbox]
    E --> F[Testes]
    F --> G{OK?}
    G -->|Sim| H[✅ Completo]
    G -->|Não| I[Tentar Novamente]
    I --> A
    H --> J([Métricas])
    ...
    style J fill:#121212,stroke:#121212,color:#fff
```

**Pontos-chave:** Claude + GPT-4 + Judge0 Sandbox + Métricas (PR, DI, CS)
